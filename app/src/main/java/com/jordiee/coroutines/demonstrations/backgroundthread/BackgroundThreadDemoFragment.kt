package com.jordiee.coroutines.demonstrations.backgroundthread
...
class BackgroundThreadDemoFragment : com.jordiee.coroutines.common.BaseFragment() {
    ...
    companion object {
        fun newInstance(): Fragment {
            return com.jordiee.coroutines.demonstrations.backgroundthread.BackgroundThreadDemoFragment()
        }
    }
}