package com.jordiee.coroutines.demonstrations.concurrentcoroutines
...
class ConcurrentCoroutinesDemoFragment : com.jordiee.coroutines.common.BaseFragment() {
    ...
    companion object {
        fun newInstance(): Fragment {
            return com.jordiee.coroutines.demonstrations.concurrentcoroutines.ConcurrentCoroutinesDemoFragment()
        }
    }
}